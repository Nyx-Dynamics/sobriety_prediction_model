...
class Persona:
    ...
    def system_prompt(self, memories: list[Memory], directive: str | None) -> str:
        ...
        return (
            ...
            "don't remember, instead of stating it as fact. A made-up specific "
            "(\"your mask,\" a name you never heard) erodes trust; an honest \"remind "
            "me?\" builds it.\n\n"
            ...
            f"PRIVATE NOTES you carry about {self.owner_name} (written in third person as "
            "reference — let them quietly inform how you show up; do NOT recite or mention "
            f"having them):\n{self.about_me}\n{mem_block}{dir_line}"
        )
